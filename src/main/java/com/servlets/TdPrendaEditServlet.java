 ...
 * @author desti
 */
@WebServlet(name = "TdPrendaEditServlet", urlPatterns = {"/TdPrendaEditServlet"})
public class TdPrendaEditServlet extends HttpServlet {
...
//      mi_lista_de_Distritos = lista_de_Distritos.findDistritoEntities();
      ...
      old_objet = jpac_object.findTipoDePrenda(Long.valueOf(request.getParameter("editId")));
      System.out.println("El tipo de prenda obtenido es: " + old_objet);
...
//      Comparando y asignando nuevos valores al departamento
      ...
      System.out.println("El depa actualizado es: "
          ...
          + old_objet.getUpdatedAt() + " - " + old_objet.getPrendaCollection());
