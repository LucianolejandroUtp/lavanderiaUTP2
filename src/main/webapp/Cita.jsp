                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group form-group-default">
                                                    ...
                                                    <input name="addFecha" id="addFecha" type="text" class="form-control" placeholder="Ingrese Fecha en recojo">
                                                </div>
                                                <div class="form-group form-group-default">
                                                    <label>Hora Cita HH:MM:ss</label>
                                                    <input name="addHora" id="addHora" type="text" class="form-control" placeholder="Ingrese hora de recojo">
                                                </div>
                        ...
                        <table id="add-row" class="display table table-striped table-hover" >
                            ...
                            <tbody>
                              ...
                              <!-- value="tempObjeto.estado" determina si lista todo o solo el primero, y permitira abrir el modal +AñadirALGO -->
                                                                <input name="editDescripcion" id="editDescripcion" type="text" class="form-control" value="${tempObjeto.estado }">
                                                            </div>
                                                            <div class="form-group form-group-default">
