                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group form-group-default">
                                                    <label>Placa</label>
                                                    <input name="addPlaca" id="addPlaca" type="text" class="form-control" placeholder="Ingrese placa vehiculo">
                                                </div>
                                                <div class="form-group form-group-default">
                                                    <label>Marca</label>
                                                    <input name="addMarca" id="addMarca" type="text" class="form-control" placeholder="Ingrese Marca del vehiculo">
                                                </div>
                                                <div class="form-group form-group-default">
                                                    <label>Modelo</label>
                                                    <input name="addModelo" id="addModelo" type="text" class="form-control" placeholder="Ingrese el modelo del vehiculo">
                                                </div>
                                                ...
                                                <form  action="DistritoEditServlet" method="post">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="form-group form-group-default">
                                                                <label>Nombre</label>
                                                                <input name="editDescripcion" id="editDescripcion" type="text" class="form-control" value="${tempObjeto.placa }">
                                                            </div>
                                                            <div class="form-group form-group-default">
